 ...
 * @author Roman
 */
@WebServlet(name = "MostrarProductosSv", urlPatterns = {"/mostrarProductos"})
public class MostrarProductosSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("/deposito/mostrar/mostrarProductos.jsp");
    }
