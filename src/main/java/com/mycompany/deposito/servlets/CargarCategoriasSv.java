 ...
 * @author Roman
 */
@WebServlet(name = "CargarCategoriasSv", urlPatterns = {"/cargarCategoria"})
public class CargarCategoriasSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("/deposito/cargar/cargaCategoria.jsp");
    }
