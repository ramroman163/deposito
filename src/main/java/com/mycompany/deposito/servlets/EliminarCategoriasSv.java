 ...
 * @author Roman
 */
@WebServlet(name = "EliminarCategoriasSv", urlPatterns = {"/eliminarCategoria"})
public class EliminarCategoriasSv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String respuesta = control.eliminarCategoria(idCategoria);
        
        if(respuesta.equalsIgnoreCase("La categoría tiene productos")){
