            ...
            <section>
                <div class="row mb-3">
                    <a href="/deposito/mostrarProductos">
                        <input class="btn btn-primary" type="button" value="Mostrar Productos">
                    </a>
                </div>
                <div class="row mb-3">
                    <a href="/deposito/mostrarCategorias">
                        <input class="btn btn-primary" type="button" value="Mostrar Categorias">
                    </a>
                </div>
                <div class="row mb-3">
                    <a href="/deposito/cargarProducto">
                        <input class="btn btn-primary" type="button" value="Cargar Productos">
                    </a>
                </div>
                <div class="row mb-3">
                    <a href="/deposito/cargar/cargaCategoria.jsp">
                        <input class="btn btn-primary" type="button" value="Cargar Categorias">
                    </a>
                </div>
            </section>
        </main>
